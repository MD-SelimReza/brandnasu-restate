    ...
    <section className="lg:py-16 bg-darkIndigo">
      <div className="text-center">
        ...
        >
          ...
          {/* 2. Priority Support */}
          <div
            className="md:col-span-2 lg:col-span-1 bg-indigo100 rounded-xl lg:pt-8 pt-6 lg:pl-8 pl-6 pb-6 bg-no-repeat bg-right-bottom bg-[length:45%_auto]"
            style={{
          ...
          {/* 3. Creative Assets */}
          <div
            className="md:col-span-2 lg:col-span-1 bg-lightIndigo rounded-xl lg:pt-8 pt-6 lg:pl-8 pl-6 pb-6 bg-no-repeat bg-right-bottom bg-[length:55%_auto]"
            style={{
          ...
          {/* 4. Scalable Strategy */}
          <div
            className="md:col-span-2 bg-[#FFA423] rounded-xl lg:pt-8 pt-6 lg:pl-8 pl-6 pb-6 bg-no-repeat bg-right-bottom xl:bg-[length:auto_75%] lg:bg-[length:auto_50%] md:bg-[length:auto_40%] bg-[length:auto_45%]"
            style={{
