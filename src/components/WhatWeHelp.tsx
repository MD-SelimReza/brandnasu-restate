      ...
      <div className="relative flex lg:flex-row flex-col gap-10 items-start">
        ...
        <div className="lg:w-1/3 w-full lg:sticky lg:top-[86px] mb-10 lg:mb-0 py-16 lg:py-24 xl:py-40 self-start">
          <div className="relative mb-6">
            <h1 className="text-2xl text-darkIndigo font-bold mb-2">
              Who We Help
            </h1>
          </div>
...
//   // Animate a horizontal border from 0% to 100%
//   const borderWidth = useTransform(scrollYProgress, [0, 1], ['0%', '100%']);

//   return (
//     <div className="relative max-w-[1440px] w-full mx-auto px-5 bg-indigo100">
//       <div className="relative flex lg:flex-row flex-col gap-10 items-start">
//         <div className="lg:w-1/3 w-full lg:sticky lg:top-[85px] sm:col-span-2 lg:col-span-1 mb-10 lg:mb-0 py-16 lg:py-24 xl:py-40">
...
// <div
//   ref={sectionRef}
//   className="lg:w-2/3 w-full grid grid-cols-1 sm:grid-cols-2 gap-10 py-16 lg:py-24 xl:py-40"
// >
//   <div className="aspect-[3/4] relative rounded-xl overflow-hidden">
//     <Image src={image} alt="Image" layout="fill" objectFit="cover" />
