...
const TestimonialsCarousel = () => {
  ...
  return (
    <div className="relative bg-[linear-gradient(to_bottom,_#F4F3FF_45%,_#673DDB_45%)]">
      <Container>
        <div className="text-center w-full h-fit relative px-2 md:px-0">
          <div className="w-full max-w-4xl mx-auto text-center">
            <h2 className="text-3xl lg:text-4xl xl:text-5xl lg:!leading-[57px] font-bold text-darkIndigo lg:max-w-4xl mx-auto md:px-10 lg:px-0 text-center">
          ...
          <div className="relative lg:mt-16 md:mt-10 mt-6 ">
            ...
            {/* Navigation Buttons */}
            <button className="prev-btn z-40 absolute -left-7 md:-left-8 top-1/2 transform -translate-y-1/2 bg-darkIndigo text-white md:p-4 p-3 rounded-full ">
              <FaChevronLeft size={30} />
            </button>
            <button className="next-btn z-40 absolute -right-7 md:-right-8 top-1/2 transform -translate-y-1/2 bg-darkIndigo text-white md:p-4 p-3 rounded-full ">
