          ...
          <SwiperSlide key={index}>
            <div className="relative min-h-[calc(100vh+84px)] h-full w-full">
              <div
                ...
                style={{ backgroundImage: `url(${banner.image.src})` }}
              >
                <div className="relative flex flex-col items-center md:pt-14 pt-8 w-full px-6 max-w-[1440px] mx-auto h-[calc(100vh-135px)] md:h-[calc(100vh-180px)] lg:h-[calc(100vh-250px)] xl:h-[calc(100vh-430px)]">
                  <h1 className="text-white xl:text-6xl text-3xl md:text-4xl font-bold max-w-7xl text-center">
                    {banner.heading}
                  </h1>
                  <p className="text-lightIndigo font-light text-lg md:text-2xl text-center mt-10">
                    {banner.subheading}
                  </p>
